...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop cryptorescuecoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "cryptorescuecoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* RESC features */
        {"cryptorescuecoin", "masternode", &masternode, true, true, false},
        {"cryptorescuecoin", "masternodelist", &masternodelist, true, true, false},
        {"cryptorescuecoin", "mnbudget", &mnbudget, true, true, false},
        {"cryptorescuecoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"cryptorescuecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cryptorescuecoin", "mnsync", &mnsync, true, true, false},
        {"cryptorescuecoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"cryptorescuecoin", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cryptorescuecoind, or the -server option to cryptorescuecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cryptorescuecoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:10992/\n";
}
