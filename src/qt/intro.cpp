...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("cryptorescuecoin Core"),
     ...
     * override -datadir in the cryptorescuecoin.conf file in the default data directory
     * (to be consistent with cryptorescuecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
