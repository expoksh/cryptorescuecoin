                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("cryptorescuecoin-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a cryptorescuecoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptorescuecoin: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About cryptorescuecoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about cryptorescuecoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for cryptorescuecoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your cryptorescuecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified cryptorescuecoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a cryptorescuecoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the cryptorescuecoin Core help message to get a list with possible cryptorescuecoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("cryptorescuecoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to cryptorescuecoin network", "", count));
}
...
{
    QString strTitle = tr("cryptorescuecoin Core"); // default title
