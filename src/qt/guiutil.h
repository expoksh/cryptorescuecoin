...
/** Utility functions used by the RESC Qt UI.
 */
namespace GUIUtil
{
...
// Render RESC addresses in monospace font
...
// Parse "cryptorescuecoin:" URI into recipient object, return true on successful parsing
