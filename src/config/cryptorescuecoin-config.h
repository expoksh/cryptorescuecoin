/* src/config/cryptorescuecoin-config.h.  Generated from cryptorescuecoin-config.h.in by configure.  */
/* src/config/cryptorescuecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef RESC_CONFIG_H

#define RESC_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://cryptorescuecoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "cryptorescuecoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "cryptorescuecoin Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cryptorescuecoin"
