...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total cryptorescuecoin balance of the wallet\n"
            "  \"Darksend_balance\": xxxxxx, (numeric) the anonymized cryptorescuecoin balance of the wallet\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in cryptorescuecoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in cryptorescuecoin/kb\n"
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"cryptorescuecoinaddress\"\n"
            "\nReturn information about the given cryptorescuecoin address.\n"
            "\nArguments:\n"
            "1. \"cryptorescuecoinaddress\"     (string, required) The cryptorescuecoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"cryptorescuecoinaddress\", (string) The cryptorescuecoin address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: RESC address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are cryptorescuecoin addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) cryptorescuecoin address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"cryptorescuecoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"cryptorescuecoinaddress\"  (string, required) The cryptorescuecoin address to use for the signature.\n"
