...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("cryptorescuecoin Core cryptorescuecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptorescuecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptorescuecoin transaction") + "\n" +
                               "  cryptorescuecoin-tx [options] -create [commands]   " + _("Create hex-encoded cryptorescuecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptorescuecoin transaction
