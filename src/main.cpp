...
#if defined(NDEBUG)
#error "cryptorescuecoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "cryptorescuecoin Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 14500 ) {
	        nSubsidy = 1 * COIN;
	} else if( nHeight > 14500 && nHeight <= 24500 ) {
	        nSubsidy = 15 * COIN;
	} else if( nHeight > 24500 && nHeight <= 34500 ) {
	        nSubsidy = 16 * COIN;
	} else if( nHeight > 34500 && nHeight <= 134500 ) {
	        nSubsidy = 17 * COIN;
	} else {
		nSubsidy = 12 * COIN;
	}
...
{
    RenameThread("cryptorescuecoin-scriptch");
