...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000008c12e8e2a94eefffc5cbfc717b0448bd57730304bd868bcf3e990d77d9c"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1548267369, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 1000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "cryptorescuecoin coin";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1548267369;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 22438368;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x000008c12e8e2a94eefffc5cbfc717b0448bd57730304bd868bcf3e990d77d9c"));
        assert(genesis.hashMerkleRoot == uint256("0x46372f326d34e695052702d4e55c238618e81ef23b25b215a3704047b4b8e89f"));
        

        vSeeds.push_back(CDNSSeedData("seed1.cryptorescuecoin.io", "seed1.cryptorescuecoin.io"));
        vSeeds.push_back(CDNSSeedData("seed2.cryptorescuecoin.io", "seed2.cryptorescuecoin.io"));
        vSeeds.push_back(CDNSSeedData("seed3.cryptorescuecoin.io", "seed3.cryptorescuecoin.io"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
        ...
        nStartMasternodePayments = 1548267369; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1548267370;
        genesis.nNonce = 21986026;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000134a04703980a54299599f260aa6b2fbc97234ce12788b5b07cf95b6e6b"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet cryptorescuecoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet cryptorescuecoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet cryptorescuecoin BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1548267370;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1548267371;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 5;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x29866057d3473ca214e3bd156d6e2218163d9f90d23e8f3f51f76f4708244df9"));
