...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='cryptorescuecoin.conf'
CONFIGFOLDER='/root/.cryptorescuecoin'
COIN_DAEMON='cryptorescuecoind'
COIN_CLI='cryptorescuecoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/JohnathanMorris/cryptorescuecoin.git'
COIN_TGZ='https://github.com/JohnathanMorris/cryptorescuecoin/releases/download/v1.1/RESC-linux.tgz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='CryptoRescueCoin'
COIN_PORT=10899
RPC_PORT=10992
